  ...
  <body>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="container">
                                <center><h1>TAMBAHKAN LAPORAN </h1></center>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="dasar_pelaksanaan" class="form-control @error('dasar_pelaksanaan') is-invalid @enderror" name="dasar_pelaksanaan" value="{{ old('dasar_pelaksanaan')}}"></textarea>
                                {{-- PESAN ERROR --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            fontNamesIgnoreCheck: ['Bookman Old Style'],
            // fontNames: Bookman Old Style,
            // fontNamesIgnoreCheck: Bookman Old Style,
            tabsize: 1,
            height: 400,
